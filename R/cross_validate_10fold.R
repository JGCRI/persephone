...
cross_validate_10fold <- function(ensSiteData, testnmes, ctwtests, individSiteDataPath, functionalform, sdfunctionalform, ensemblename, testpartition){
